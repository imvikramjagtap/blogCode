    ...
    <>
      <div className="mx-60 bg-slate-100 px-20">
        <div className="p-5">
          ...
          <div className="py-5">
            {!updateMode && (
              <p className="first-letter:capitalize first-letter:text-3xl first-letter:font-serif first-letter:font-semibold text-slate-600">
                {post.desc}
              </p>
            )}
            {updateMode && (
              <textarea
                className="w-full mt-5 h-60 text-slate-600 p-2 focus:outline-none rounded-lg"
                type="text"
                value={desc}
